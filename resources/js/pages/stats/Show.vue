    ...
    datasets: [
        {
            ...
            data: [
                props.quizScoreDistribution.green || 0,
                props.quizScoreDistribution.yellow || 0,
                props.quizScoreDistribution.red || 0,
            ],
        },
    ],
};
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                    ...
                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Consecutive days with lesson completions.</p>
                </div>
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                    ...
                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Total number of quizzes you've started.</p>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <!-- Pie Chart -->
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                    <div class="h-80 md:h-96"> <!-- Set a fixed height for the chart container -->
                        <Pie v-if="quizScoreDistribution.green || quizScoreDistribution.yellow || quizScoreDistribution.red"
                             :data="pieChartData"
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                    <div class="h-80 md:h-96"> <!-- Set a fixed height for the chart container -->
                        <Bar v-if="lessonContributionData.length > 0"
                             :data="contributionBarChartData"
                             :options="contributionBarChartOptions" />
                        <div v-else class="flex items-center justify-center h-full text-gray-500 dark:text-gray-400">
